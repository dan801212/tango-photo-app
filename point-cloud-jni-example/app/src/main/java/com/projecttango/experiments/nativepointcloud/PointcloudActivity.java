...
public class PointcloudActivity extends Activity implements OnClickListener {
  ...
  private final int kTextUpdateIntervalms = 2000;

  private GLSurfaceView mGLView;
  private GLSurfaceView camera_GLView;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mTts=new TextToSpeech(PointcloudActivity.this, new TextToSpeech.OnInitListener() {
...
//    text[6] = "Move Closer";
    ...
    camera_GLView.setZOrderMediaOverlay(true);
    camera_GLView.setRenderer(new CameraRender());
              ...
              runOnUiThread(new Runnable() {
                ...
                public void run() {
                  try {
                    ...
                    mTts.speak(text[TangoJNINative.getDirection()],TextToSpeech.QUEUE_FLUSH,null);
                  } catch (Exception e) {
                      e.printStackTrace();
                  }
                }
